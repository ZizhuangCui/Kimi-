...
def main():
    ...
    input_folder = '/Users/cui/Desktop/deepglint/DeepSeek/186test'  # 修改为你的文件夹路径
        ...
        for filename in files:
            if filename.endswith(".txt"):
                ...
                try:
                    query = """
                    对于这份语音转录文本：
                    文本中至少有两名对话者，房产销售和客户，我需要你识别并提取出其中“客户的信息”：
                        首付预算
                        总购房预算
                        意向户型
                        意向购房面积
                     ...
                     遵照模板中的24个问题，简短回答，根据对话逻辑尽量都能回答上，不确定的答案请用原文解释备注，或合理使用是否回答。并且在每个答案后面给出一个0-100%的该答案的准确率比例
                        """
